							...
							<div class="widget-content nopadding">
								...
								<s:iterator value="#session.clientShow" id="c">
										<tr>
											...
											<td><a class="btn btn-primary" href="ClientAction!myEdit?id=<s:property value="#c.id"/>"><i class="icon-pencil icon-white"></i> 冻结</a>
									<a class="btn btn-danger"  href="javascript:if(confirm('确实要删除该用户吗?'))location='ClientAction!myDel?id=<s:property value="#c.id"/>'"><i class="icon-remove icon-white"></i> 删除</a></td>
										</tr>
									</s:iterator>
									</tbody>
								</table>							
